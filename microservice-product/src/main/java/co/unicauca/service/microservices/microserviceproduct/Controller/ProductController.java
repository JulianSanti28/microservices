package co.unicauca.service.microservices.microserviceproduct.Controller;
...
public class ProductController {
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<Product> updateProduct(@PathVariable("id") Long id, @Valid @RequestBody @NotNull Product product){
        product.setId(id);
